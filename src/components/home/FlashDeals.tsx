  ...
  return (
    <section id="deals" className="py-12 bg-slate-100/70 dark:bg-[#121217]/60 border-y border-black/5 dark:border-white/5 relative w-full max-w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-black/10 dark:border-white/10">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FF6B00]/15 dark:bg-[#FF6B00]/20 border border-[#FF6B00]/30 dark:border-[#FF6B00]/40 text-[#FF6B00] text-xs font-mono font-bold uppercase">
          ...
          {/* Countdown Clock */}
          <div className="flex items-center gap-3 bg-white dark:bg-[#18181F] border border-black/10 dark:border-[#FFAA2C]/30 rounded-2xl p-3 shadow-md shadow-black/5 dark:shadow-[#FFAA2C]/10">
            ...
            <div className="flex items-center gap-1 font-mono text-center">
              <div className="bg-slate-100 dark:bg-[#0D0D11] border border-black/5 dark:border-white/10 px-2.5 py-1.5 rounded-lg">
              ...
              <span className="text-[#FFAA2C] font-bold">:</span>
              <div className="bg-slate-100 dark:bg-[#0D0D11] border border-[#FF6B00]/40 px-2.5 py-1.5 rounded-lg">
