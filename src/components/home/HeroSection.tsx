      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {heroProduct ? (
          ...
          <div className="lg:hidden mb-8">
            <div className="bg-[#14141B] border border-white/10 rounded-3xl p-6 text-center space-y-3">
              ...
              <h2 className="text-xl font-black text-[#F5F5F7]">
        ...
        <div className="hidden lg:grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            {heroProduct ? (
              ...
              <div className="relative mx-auto max-w-md bg-[#18181F]/80 backdrop-blur-2xl border border-white/15 rounded-3xl p-8 text-center space-y-4">
