...
-- Migration safety for existing categories table
ALTER TABLE public.categories ADD COLUMN IF NOT EXISTS sizes JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE public.categories ADD COLUMN IF NOT EXISTS colors JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE public.categories ADD COLUMN IF NOT EXISTS variant_type TEXT NOT NULL DEFAULT 'none';

ALTER TABLE public.categories DISABLE ROW LEVEL SECURITY;

-- Initial Seed Categories (Electronics, Fashion, Shoes, Smartphones, Watches)
